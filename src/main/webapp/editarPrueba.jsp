...
<body>
    ...
    <section class="login-clean">
        <form action="./pepe?accion=insertar" method="post" >
            <h2 class="sr-only">Login Form</h2>
            <div class="illustration"><i class="fas fa-rocket" style="color: #5319c3;"></i></div>
            <div class="form-group"><input class="form-control" type="text" name="nick" placeholder="Nick"></div>
            <div class="form-group"><input class="form-control" type="text" name="first_name" placeholder="Nombre"></div>
